...
public class ClassLoaderJavaObjectInput extends NativeJavaObjectInput {
    ...
    public ClassLoaderJavaObjectInput(InputStream is) throws IOException {
        super(
            (ObjectInputStream) (is instanceof ObjectInputStream ? is : new ObjectInputStream(is)));
    }

    public ClassLoaderJavaObjectInput(InputStream is, boolean compacted) throws IOException {
        super(compacted ? new CompactedObjectInputStream(is)
            : ((ObjectInputStream) (is instanceof ObjectInputStream ? is
