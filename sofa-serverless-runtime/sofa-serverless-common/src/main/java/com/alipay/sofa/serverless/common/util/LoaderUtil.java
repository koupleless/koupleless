...
public final class LoaderUtil {
    ...
    private static final SecurityManager               SECURITY_MANAGER     = System
                                                                                .getSecurityManager();
    ...
    public static ClassLoader getThreadContextClassLoader() {
        ...
        return SECURITY_MANAGER == null ? TCCL_GETTER.run() : AccessController
    ...
    private static class ThreadContextClassLoaderGetter implements PrivilegedAction<ClassLoader> {
        ...
        public ClassLoader run() {
            ...
            return ccl == null && !GET_CLASS_LOADER_DISABLED ? ClassLoader.getSystemClassLoader()
                : ccl;
        }
    }
     ...
     * @since 2.7
     */
    public static <T> T newInstanceOf(final Class<T> clazz) throws InstantiationException,
    ...
    public static <T> T newInstanceOf(final String className) throws ClassNotFoundException,
                                                             IllegalAccessException,
    ...
    private static boolean isIgnoreTccl() {
        ...
        if (ignoreTCCL == null) {
            final String ignoreTccl = PropertiesUtil.getProperties().getStringProperty(
                IGNORE_TCCL_PROPERTY, null);
