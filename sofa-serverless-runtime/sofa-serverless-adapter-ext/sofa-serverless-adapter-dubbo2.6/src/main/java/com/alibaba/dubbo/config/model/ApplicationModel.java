...
public class ApplicationModel {
    ...
    public static boolean initConsumerModel(String serviceName, ConsumerModel consumerModel) {
        if (consumedServices
            .putIfAbsent(
                getConsumerModelKey(serviceName, consumerModel.getMetadata().getApplication()
                    .getName()), consumerModel) != null) {
    ...
    public static String getConsumerModelKey(String serviceName, String applicationName) {
