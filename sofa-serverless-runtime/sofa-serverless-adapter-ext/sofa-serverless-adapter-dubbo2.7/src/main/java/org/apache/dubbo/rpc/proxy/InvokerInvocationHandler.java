...
public class InvokerInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        RpcInvocation rpcInvocation = new RpcInvocation(method, invoker.getInterface().getName(),
            protocolServiceKey, args);
        ...
        try {
            Thread.currentThread().setContextClassLoader(consumerModel.getClassLoader());
