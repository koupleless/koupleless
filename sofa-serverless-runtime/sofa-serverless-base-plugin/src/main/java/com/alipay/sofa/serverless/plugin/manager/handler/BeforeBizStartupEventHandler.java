...
public class BeforeBizStartupEventHandler implements EventHandler<BeforeBizStartupEvent> {
    ...
    public void handleEvent(BeforeBizStartupEvent beforeBizStartupEvent) {
        Biz biz = beforeBizStartupEvent.getSource();
        // can't get applicationContext here, so register a empty applicationContext
        BizRuntimeContextRegistry.registerSpringContext(new BizRuntimeContext(biz, null));
    }
